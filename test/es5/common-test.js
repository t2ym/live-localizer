...
var OpenDialog = function (_InstantiateTest) {
  _inherits(OpenDialog, _InstantiateTest);

  function OpenDialog() {
    _classCallCheck(this, OpenDialog);

    return _possibleConstructorReturn(this, (OpenDialog.__proto__ || Object.getPrototypeOf(OpenDialog)).apply(this, arguments));
  }
